$(function() {
   ...
   ========================================================================== */
    ...
    $.ajaxChimp.translations.cm = {
        'submit': 'הַגָשָׁה...',
        0: '<i class="fa fa-envelope"></i> מדהים! שלחנו לך דוא"ל אישור',
        1: '<i class="fa fa-exclamation-triangle"></i> אנא הכנס ערך',
        2: '<i class="fa fa-exclamation-triangle"></i> כתובת הדוא"ל חייבת להכיל אחת @',
        3: '<i class="fa fa-exclamation-triangle"></i> החלק המושלם של כתובת הדוא"ל אינו חוקי (החלק שאחרי הסימן @: )',
        4: '<i class="fa fa-exclamation-triangle"></i> בחלק של שם המשתמש של כתובת הדואר האלקטרונית אינו חוקי (חלק שלפני @: )',
        5: '<i class="fa fa-exclamation-triangle"></i> כתובת דוא"ל זו דומה מזויפת או לא חוקית. נא להזין את כתובת דוא"ל אמיתית'
    };
